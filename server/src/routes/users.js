...
// --- Jeton de notification push d'un appareil mobile (app Expo) ---
...
router.post("/me/push-token", requireAuth, async (req, res) => {
  try {
    ...
    // Le même jeton peut avoir appartenu à un AUTRE compte (téléphone prêté,
    // changement de compte) : on le décroche partout avant de le rattacher ici,
...
// --- Retrait d'un jeton (déconnexion volontaire depuis l'app) ---
